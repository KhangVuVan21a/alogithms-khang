...
//		System.out.println(dao.search( new Category(1, "Computer")));
//		System.out.println(dao.insert( new Category(5, "Accessoryyyyyyy")));
//		System.out.println(dao.update( new Category(5, "Acces")));
//		System.out.println(dao.delete(new Category(5, "Acces")));
//		System.out.println(dao.findAll(Category.class.getName()));
//		System.out.println(dao.findById(Category.class.getName(),2));
//	}
